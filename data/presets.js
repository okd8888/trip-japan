...
window.PRESETS = {
  ...
  destinations: [
    ...
    },
    {
      ...
      currency: { code: "JPY", symbol: "¥", name: "日圓" },
      tips: "博多為交通樞紐，JR 九州鐵路周遊券很划算；由布院、別府、熊本都可當日來回。",
      checklist: ["護照", "Visit Japan Web", "JR 九州鐵路周遊券（或自駕：駕照日文譯本）", "SUGOCA／西瓜卡", "好走的鞋", "折疊傘", "泡湯用小毛巾"],
      spots: [
        { name: "太宰府天滿宮", desc: "學問之神，參道上的梅枝餅要趁熱吃。", tag: "" },
        { name: "櫛田神社", desc: "博多總鎮守，境內可看到祇園山笠的裝飾山車。", tag: "" },
        { name: "中洲屋台", desc: "河畔路邊攤，18:00 後開始營業，拉麵與關東煮。", tag: "晚餐" },
        { name: "博多運河城 Canal City", desc: "室內購物中心，每小時有噴水秀。", tag: "購物" },
        { name: "天神地下街", desc: "全長 590 公尺的地下商店街，雨天備案。", tag: "購物" },
        { name: "福岡塔", desc: "234 公尺海濱塔，傍晚上去可同時看日落與夜景。", tag: "門票", cost: 800 },
        { name: "大濠公園", desc: "市區內的大池塘與步道，旁邊是舞鶴公園福岡城跡。", tag: "" },
        { name: "糸島 夫婦岩", desc: "海岸公路與海邊咖啡廳，自駕或包車最方便。", tag: "自駕" },
        { name: "海之中道海濱公園", desc: "四季花海與動物之森。", tag: "門票", cost: 450 },
        { name: "九州國立博物館", desc: "緊鄰太宰府，有手扶梯直達。", tag: "門票", cost: 700 },
        { name: "門司港懷舊區", desc: "大正時期洋樓建築群，名物是燒咖哩。", tag: "" },
        { name: "小倉城", desc: "北九州地標，旁邊是旦過市場。", tag: "門票", cost: 350 },
        { name: "由布院・金鱗湖", desc: "溫泉街散步與湯之坪街道，從博多約 2 小時。", tag: "一日行程" },
        { name: "別府地獄溫泉巡禮", desc: "海地獄、血之池地獄等七處，共通觀覽券最划算。", tag: "門票", cost: 2200 },
        { name: "熊本城", desc: "震後修復中，空中迴廊可近距離看天守閣。", tag: "門票", cost: 800 },
        { name: "阿蘇火山・草千里", desc: "火口開放與否依當日火山活動，出發前查官網。", tag: "自駕" },
        { name: "高千穗峽", desc: "峽谷划船看真名井瀑布，建議一早去排隊。", tag: "一日行程", cost: 4100 },
        { name: "柳川遊船", desc: "水鄉遊船約 70 分鐘，名物是蒸籠鰻魚飯。", tag: "門票", cost: 1900 }
      ]
    },
    {
